 ...
 */
final class Version20221101212255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coins (id INT NOT NULL, coingecko_id VARCHAR(255) NOT NULL, symbol VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, is_favorite BOOLEAN NOT NULL, created DATE NOT NULL, price DOUBLE PRECISION NOT NULL, image VARCHAR(255) NOT NULL, price_updated DATE NOT NULL, PRIMARY KEY(id))');
